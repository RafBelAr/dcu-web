...
function Material (props) {
    return (
        <div className="flex flex-col p-3 shadow-xl w-40 justify-center  m-2 border border-gray-200 border-solid container">
            ...
            <button className="w-32 bg-blue-400 p-3 text-white font-semibold text-sm border-none rounded-[37px] focus:ring-blue-500 focus:border-blue-500 hover:scale-105" type="submit" >Agregar</button>
        </div>
    );
}
