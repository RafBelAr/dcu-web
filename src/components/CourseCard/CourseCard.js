function CourseCard (props) {
    return (
        <div className="p-1 flex flex-col space-y-1 border-solid border-2 border-black max-w-80">
            ...
            <div className="flex flex-row flex-space-x-4 p-1 max-h-32">
                ...
                <p className="basis-3/4 p-1 text-left self-center text-ellipsis ">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ultricies nunc id justo imperdiet dignissim.</p>
            </div>
